class ConstanteRepositorio {

  static String doencaTabela = 'tabela_doencas';
  ...
  static String perguntaTabela_colDoenca = 'doenca';
  static String perguntaTabela_colTexto = 'texto';
  static String perguntaTabela_colAlternativa1 = 'alternativa1';
  static String perguntaTabela_colAlternativa2 = 'alternativa2';
  static String perguntaTabela_colAlternativa3 = 'alternativa3';
